...
## anytype-heart v0.50.10

The optional `heart-adapter` links against [anytype-heart](https://github.com/anyproto/anytype-heart/tree/v0.50.10). That dependency is not licensed under Apache-2.0. It is governed by the Any Source Available License 1.0 reproduced below. Review its Non-Commercial Use and Allowed Networks restrictions before building, using, or distributing the adapter binary.
